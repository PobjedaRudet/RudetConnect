<x-app-layout>
    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <thead class="bg-gray-50">
            <tr>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Wrestler</th>
                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Signature Move(s)</th>
            </tr>
        </thead>
        <tbody class="bg-white divide-y divide-gray-200">
            <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">"Stone Cold" Steve Austin</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Stone Cold Stunner, Lou Thesz Press</td>
            </tr>
            <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Bret "The Hitman" Hart</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">The Sharpshooter</td>
            </tr>
            <tr>
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">Razor Ramon</td>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Razor's Edge, Fallaway Slam</td>
            </tr>
        </tbody>
    </table>
